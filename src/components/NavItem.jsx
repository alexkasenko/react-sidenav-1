...
class NavItem extends React.PureComponent {
    ...
    addItems = () => {
        const {
            eventKey, selected, children,
            activeItems, highlightedItems, subLevel,
            addActiveItem, addHighlightedItem
        } = this.props;
        ...
        React.Children.toArray(children)
            .filter(child => {
                ...
                const isChildSelected = child.props.eventKey === selected;
                const isHighlighted = selected === eventKey
    ...
    render() {
        const {
            ...
            activeItems, highlightedItems, subLevel,
            addActiveItem, toggleExpanded, addHighlightedItem, //eslint-disable-line 
            ...props
        } = this.props;
                ...
                return (
                    ...
                    >
                        ...
                        <div style={{ background: '#F8F8F9' }}>
                            <div style={{ height: '1px', background: '#e5e5e4', marginRight: '20px', marginLeft: '20px' }} />
                        </div>
